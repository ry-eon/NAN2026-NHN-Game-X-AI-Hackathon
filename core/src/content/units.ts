// 역할 원형 6종 (구 직군 — 블로커/브루저/원거리/광역/힐러/특수).
// 캐릭터 중심 개편(2026-07-20)에 따라 게임에 직접 등장하지 않고,
// 캐릭터(characters.ts)의 스탯 원형이자 소프트 파이프라인의 밸런스 기준점이다.
// 기계적 테스트(core/test)는 원형으로 검증한다. 수치는 전부 [초안].
